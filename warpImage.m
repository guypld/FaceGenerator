function [warpedImage] = warpImage(Image, Ox, Oy, Tx, Ty)
...
[x y zx, zy] = getPoints(Image, Ox, Oy, Tx, Ty);
...
function [x, y, zx, zy]   =  getPoints(Image, Ox, Oy, Tx, Ty)
...
% for i = 1:numPoints(2)
%     
%     zx(i) = Ox{1,i} - Tx{1,i};   % x offset component of the displacement vector
%     zy(i) = Oy{1,i} - Ty{1,i};   % x offset component of the displacement vector
% 
%     x(i) = Ox{1,i};
%     y(i) = Oy{1,i};
%     
% end
    zx = Ox - Tx;   % x offset component of the displacement vector
    zy = Oy - Ty;   % x offset component of the displacement vector
